...
<body>
        ...
        <div class="admin-main-wrapper">
            ...
            <main class="admin-main-content">
                ...
                <div class="admin-page-header">
                    ...
                    <p class="admin-page-subtitle">Tambah, edit, dan hapus kategori pengaduan</p>
                </div>
                ...
                <div class="content-card">
                    <div class="form-grid">
                        ...
                        <div class="form-section">
                            <h3><div class="icon icon-plus icon-sm" style="display: inline-block; margin-right: 8px; color: var(--primary-600);"></div>Tambah Kategori Baru</h3>
                            <form method="POST" action="/admin/categories">
                                ...
                                <div class="form-group">
                                    ...
                                    <input 
                                        ...
                                        required
                                        maxlength="30"
                                        placeholder="Contoh: Kerusakan Sarana"
                                    >
                                </div>
                                
                                <div class="form-group">
                                    <label for="category_description" class="form-label">Deskripsi (Opsional)</label>
                                    <textarea 
                                        ...
                                        rows="3"
                                        maxlength="500"
                                        placeholder="Deskripsi kategori untuk memberikan penjelasan lebih detail..."
                        ...
                        <!-- Daftar Kategori -->
                        <div>
                            <h3><div class="icon icon-folder icon-sm" style="display: inline-block; margin-right: 8px; color: var(--primary-600);"></div>Daftar Kategori (<?= count($categories) ?>)</h3>
                            <div class="category-list">
                                <?php if (!empty($categories)): ?>
                                    <?php foreach ($categories as $category): ?>
                                        <div class="category-item">
                                            <span class="category-name"><?= htmlspecialchars($category['ket_kategori']) ?></span>
                                            <div class="category-actions">
                                                <button onclick="viewCategoryDetail(<?= $category['id_kategori'] ?>, '<?= addslashes(htmlspecialchars($category['ket_kategori'])) ?>')" 
                                                        class="btn btn-info btn-sm">
                                                    <div class="icon icon-eye icon-sm"></div>
                                                    Detail
                                                </button>
                                                <button onclick="editCategory(<?= $category['id_kategori'] ?>, '<?= addslashes(htmlspecialchars($category['ket_kategori'])) ?>')" 
                                                        class="btn btn-secondary btn-sm">
                                                    <div class="icon icon-edit icon-sm"></div>
                                                    Edit
                                                </button>
                                                <button onclick="deleteCategory(<?= $category['id_kategori'] ?>, '<?= addslashes(htmlspecialchars($category['ket_kategori'])) ?>')" 
    ...
    <script>
        function viewCategoryDetail(id, name) {
            // Show loading
            Swal.fire({
                title: 'Memuat Detail...',
            ...
            fetch(`/admin/categories/detail?id=${id}`)
                .then(response => {
                ...
                .then(data => {
                    ...
                    if (data.success) {
                        ...
                        Swal.fire({
                            title: 'Error!',
                            text: data.message || 'Gagal memuat detail kategori',
                            icon: 'error',
                            confirmButtonColor: 'var(--primary-600)'
                        });
                    }
        ...
        function editCategory(id, name) {
            // First get the current category data including description
            fetch(`/admin/categories/detail?id=${id}`)
                    ...
                    if (data.success) {
                        ...
                        Swal.fire({
                            ...
                            html: `
                                <div style="text-align: left;">
                                    <div style="margin-bottom: 16px;">
                                        <label style="display: block; margin-bottom: 8px; font-weight: 600; color: #374151;">Nama Kategori</label>
                                        <input 
                                            id="edit-category-name" 
                                            type="text" 
                                            value="${category.ket_kategori}" 
                                            maxlength="30"
                            ...
                            preConfirm: () => {
                                ...
                                if (name.length > 30) {
                                    Swal.showValidationMessage('Nama kategori maksimal 30 karakter');
                                    return false;
                                }
                            ...
                            if (result.isConfirmed) {
                                ...
                                descInput.name = 'category_description';
